/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/netwerk/base/public/nsIDashboard.idl
 */
...
#define NS_DECL_NSIDASHBOARD \
  ...
  NS_IMETHOD RequestConnection(const nsACString & aHost, uint32_t aPort, const char * aProtocol, uint32_t aTimeout, NetDashboardCallback *cb); \
  NS_IMETHOD GetEnableLogging(bool *aEnableLogging); \
  NS_IMETHOD SetEnableLogging(bool aEnableLogging); \
  NS_IMETHOD RequestDNSLookup(const nsACString & aHost, NetDashboardCallback *cb); 
...
#define NS_FORWARD_NSIDASHBOARD(_to) \
  ...
  NS_IMETHOD RequestConnection(const nsACString & aHost, uint32_t aPort, const char * aProtocol, uint32_t aTimeout, NetDashboardCallback *cb) { return _to RequestConnection(aHost, aPort, aProtocol, aTimeout, cb); } \
  ...
  NS_IMETHOD RequestDNSLookup(const nsACString & aHost, NetDashboardCallback *cb) { return _to RequestDNSLookup(aHost, cb); } 
...
#define NS_FORWARD_SAFE_NSIDASHBOARD(_to) \
  ...
  NS_IMETHOD RequestConnection(const nsACString & aHost, uint32_t aPort, const char * aProtocol, uint32_t aTimeout, NetDashboardCallback *cb) { return !_to ? NS_ERROR_NULL_POINTER : _to->RequestConnection(aHost, aPort, aProtocol, aTimeout, cb); } \
  ...
  NS_IMETHOD RequestDNSLookup(const nsACString & aHost, NetDashboardCallback *cb) { return !_to ? NS_ERROR_NULL_POINTER : _to->RequestDNSLookup(aHost, cb); } 
