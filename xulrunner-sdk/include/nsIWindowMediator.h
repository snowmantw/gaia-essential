/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/xpfe/appshell/public/nsIWindowMediator.idl
 */
...
#define NS_DECL_NSIWINDOWMEDIATOR \
  ...
  NS_IMETHOD GetCurrentInnerWindowWithId(uint64_t aInnerWindowID, nsIDOMWindow * *_retval); \
...
#define NS_FORWARD_NSIWINDOWMEDIATOR(_to) \
  ...
  NS_IMETHOD GetCurrentInnerWindowWithId(uint64_t aInnerWindowID, nsIDOMWindow * *_retval) { return _to GetCurrentInnerWindowWithId(aInnerWindowID, _retval); } \
...
#define NS_FORWARD_SAFE_NSIWINDOWMEDIATOR(_to) \
  ...
  NS_IMETHOD GetCurrentInnerWindowWithId(uint64_t aInnerWindowID, nsIDOMWindow * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCurrentInnerWindowWithId(aInnerWindowID, _retval); } \
