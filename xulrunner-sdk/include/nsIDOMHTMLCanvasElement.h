/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/dom/interfaces/html/nsIDOMHTMLCanvasElement.idl
 */
...
#define NS_IDOMHTMLCANVASELEMENT_IID_STR "788f69a4-30e0-42b4-804d-b99549f9d463"

#define NS_IDOMHTMLCANVASELEMENT_IID \
  {0x788f69a4, 0x30e0, 0x42b4, \
    { 0x80, 0x4d, 0xb9, 0x95, 0x49, 0xf9, 0xd4, 0x63 }}
...
class NS_NO_VTABLE nsIDOMHTMLCanvasElement : public nsIDOMHTMLElement {
 public: 
  ...
  /* [implicit_jscontext] void toBlob (in nsIFileCallback callback, [optional] in DOMString type, [optional] in jsval params); */
  NS_IMETHOD ToBlob(nsIFileCallback *callback, const nsAString & type, const JS::Value & params, JSContext* cx) = 0;
...
#define NS_DECL_NSIDOMHTMLCANVASELEMENT \
  ...
  NS_IMETHOD ToBlob(nsIFileCallback *callback, const nsAString & type, const JS::Value & params, JSContext* cx); \
...
#define NS_FORWARD_NSIDOMHTMLCANVASELEMENT(_to) \
  ...
  NS_IMETHOD ToBlob(nsIFileCallback *callback, const nsAString & type, const JS::Value & params, JSContext* cx) { return _to ToBlob(callback, type, params, cx); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLCANVASELEMENT(_to) \
  ...
  NS_IMETHOD ToBlob(nsIFileCallback *callback, const nsAString & type, const JS::Value & params, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->ToBlob(callback, type, params, cx); } \
...
/* [implicit_jscontext] void toBlob (in nsIFileCallback callback, [optional] in DOMString type, [optional] in jsval params); */
NS_IMETHODIMP nsDOMHTMLCanvasElement::ToBlob(nsIFileCallback *callback, const nsAString & type, const JS::Value & params, JSContext* cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
