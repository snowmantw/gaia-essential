/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/dom/interfaces/base/nsIBrowserDOMWindow.idl
 */
...
class NS_NO_VTABLE nsIBrowserDOMWindow : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetContentWindow(JS::Value *aContentWindow) = 0;
...
#define NS_DECL_NSIBROWSERDOMWINDOW \
  ...
  NS_IMETHOD GetContentWindow(JS::Value *aContentWindow); 
...
#define NS_FORWARD_NSIBROWSERDOMWINDOW(_to) \
  ...
  NS_IMETHOD GetContentWindow(JS::Value *aContentWindow) { return _to GetContentWindow(aContentWindow); } 
...
#define NS_FORWARD_SAFE_NSIBROWSERDOMWINDOW(_to) \
  ...
  NS_IMETHOD GetContentWindow(JS::Value *aContentWindow) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetContentWindow(aContentWindow); } 
...
/* readonly attribute jsval contentWindow; */
NS_IMETHODIMP nsBrowserDOMWindow::GetContentWindow(JS::Value *aContentWindow)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
