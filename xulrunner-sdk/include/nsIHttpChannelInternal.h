/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/netwerk/protocol/http/nsIHttpChannelInternal.idl
 */
...
#define NS_IHTTPCHANNELINTERNAL_IID_STR "5b4b2632-cee4-11e2-8e84-c7506188709b"

#define NS_IHTTPCHANNELINTERNAL_IID \
  {0x5b4b2632, 0xcee4, 0x11e2, \
    { 0x8e, 0x84, 0xc7, 0x50, 0x61, 0x88, 0x70, 0x9b }}
...
#define NS_FORWARD_NSIHTTPCHANNELINTERNAL(_to) \
  ...
  NS_IMETHOD TakeAllSecurityMessages(nsCOMArray<nsISecurityConsoleMessage> & aMessages) { return _to TakeAllSecurityMessages(aMessages); } \
...
#define NS_FORWARD_SAFE_NSIHTTPCHANNELINTERNAL(_to) \
  ...
  NS_IMETHOD TakeAllSecurityMessages(nsCOMArray<nsISecurityConsoleMessage> & aMessages) { return !_to ? NS_ERROR_NULL_POINTER : _to->TakeAllSecurityMessages(aMessages); } \
