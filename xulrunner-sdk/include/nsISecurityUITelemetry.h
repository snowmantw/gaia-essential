/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/security/manager/boot/public/nsISecurityUITelemetry.idl
 */
...
#define NS_ISECURITYUITELEMETRY_IID_STR "f7259bf4-1f2b-4e9e-8983-1978cc076fa1"

#define NS_ISECURITYUITELEMETRY_IID \
  {0xf7259bf4, 0x1f2b, 0x4e9e, \
    { 0x89, 0x83, 0x19, 0x78, 0xcc, 0x07, 0x6f, 0xa1 }}
...
class NS_NO_VTABLE nsISecurityUITelemetry : public nsISupports {
 public: 
  ...
  enum {
    ...
    WARNING_BAD_CERT_TOP = 68U,
    WARNING_BAD_CERT_TOP_STS = 69U,
    WARNING_BAD_CERT_TOP_CLICK_ADD_EXCEPTION = 70U,
    WARNING_BAD_CERT_TOP_CLICK_VIEW_CERT = 71U,
    WARNING_BAD_CERT_TOP_DONT_REMEMBER_EXCEPTION = 72U,
    WARNING_BAD_CERT_TOP_GET_ME_OUT_OF_HERE = 73U,
    WARNING_BAD_CERT_TOP_UNDERSTAND_RISKS = 74U,
    WARNING_BAD_CERT_TOP_TECHNICAL_DETAILS = 75U,
