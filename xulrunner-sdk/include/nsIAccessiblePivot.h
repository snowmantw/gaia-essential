/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/accessible/public/nsIAccessiblePivot.idl
 */
...
#define NS_IACCESSIBLEPIVOT_IID_STR "c2938033-e240-4fe5-9cb6-e7ad649ccd10"

#define NS_IACCESSIBLEPIVOT_IID \
  {0xc2938033, 0xe240, 0x4fe5, \
    { 0x9c, 0xb6, 0xe7, 0xad, 0x64, 0x9c, 0xcd, 0x10 }}
...
#define NS_DECL_NSIACCESSIBLEPIVOT \
  ...
  NS_IMETHOD GetModalRoot(nsIAccessible * *aModalRoot); \
  NS_IMETHOD SetModalRoot(nsIAccessible *aModalRoot); \
...
#define NS_FORWARD_NSIACCESSIBLEPIVOT(_to) \
  ...
  NS_IMETHOD GetModalRoot(nsIAccessible * *aModalRoot) { return _to GetModalRoot(aModalRoot); } \
  NS_IMETHOD SetModalRoot(nsIAccessible *aModalRoot) { return _to SetModalRoot(aModalRoot); } \
...
#define NS_FORWARD_SAFE_NSIACCESSIBLEPIVOT(_to) \
  ...
  NS_IMETHOD GetModalRoot(nsIAccessible * *aModalRoot) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetModalRoot(aModalRoot); } \
  NS_IMETHOD SetModalRoot(nsIAccessible *aModalRoot) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetModalRoot(aModalRoot); } \
...
#define NS_IACCESSIBLETRAVERSALRULE_IID_STR "366fe92b-44c9-4769-ae40-7c2a075d3b16"

#define NS_IACCESSIBLETRAVERSALRULE_IID \
  {0x366fe92b, 0x44c9, 0x4769, \
    { 0xae, 0x40, 0x7c, 0x2a, 0x07, 0x5d, 0x3b, 0x16 }}
