/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/dom/plugins/base/nsIPluginTag.idl
 */
...
#define NS_IPLUGINTAG_IID_STR "0354d96d-3fd3-4365-a0a2-6c807ec1ce95"

#define NS_IPLUGINTAG_IID \
  {0x0354d96d, 0x3fd3, 0x4365, \
    { 0xa0, 0xa2, 0x6c, 0x80, 0x7e, 0xc1, 0xce, 0x95 }}
...
#define NS_DECL_NSIPLUGINTAG \
  ...
  NS_IMETHOD GetMimeTypes(uint32_t *aCount, PRUnichar * **aResults); \
  NS_IMETHOD GetMimeDescriptions(uint32_t *aCount, PRUnichar * **aResults); \
  NS_IMETHOD GetExtensions(uint32_t *aCount, PRUnichar * **aResults); 
...
#define NS_FORWARD_NSIPLUGINTAG(_to) \
  ...
  NS_IMETHOD GetMimeTypes(uint32_t *aCount, PRUnichar * **aResults) { return _to GetMimeTypes(aCount, aResults); } \
  NS_IMETHOD GetMimeDescriptions(uint32_t *aCount, PRUnichar * **aResults) { return _to GetMimeDescriptions(aCount, aResults); } \
  NS_IMETHOD GetExtensions(uint32_t *aCount, PRUnichar * **aResults) { return _to GetExtensions(aCount, aResults); } 
...
#define NS_FORWARD_SAFE_NSIPLUGINTAG(_to) \
  ...
  NS_IMETHOD GetMimeTypes(uint32_t *aCount, PRUnichar * **aResults) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMimeTypes(aCount, aResults); } \
  NS_IMETHOD GetMimeDescriptions(uint32_t *aCount, PRUnichar * **aResults) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMimeDescriptions(aCount, aResults); } \
  NS_IMETHOD GetExtensions(uint32_t *aCount, PRUnichar * **aResults) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetExtensions(aCount, aResults); } 
...
/* void getMimeTypes ([optional] out unsigned long aCount, [array, size_is (aCount), retval] out wstring aResults); */
NS_IMETHODIMP nsPluginTag::GetMimeTypes(uint32_t *aCount, PRUnichar * **aResults)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void getMimeDescriptions ([optional] out unsigned long aCount, [array, size_is (aCount), retval] out wstring aResults); */
NS_IMETHODIMP nsPluginTag::GetMimeDescriptions(uint32_t *aCount, PRUnichar * **aResults)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void getExtensions ([optional] out unsigned long aCount, [array, size_is (aCount), retval] out wstring aResults); */
NS_IMETHODIMP nsPluginTag::GetExtensions(uint32_t *aCount, PRUnichar * **aResults)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
