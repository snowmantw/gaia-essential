/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/content/base/public/nsIMessageManager.idl
 */
...
class NS_NO_VTABLE nsIMessageSender : public nsIMessageListenerManager {
 public: 
  ...
  /* [implicit_jscontext,optional_argc] void sendAsyncMessage ([optional] in AString messageName, [optional] in jsval obj, [optional] in jsval objects); */
  NS_IMETHOD SendAsyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc) = 0;
...
#define NS_DECL_NSIMESSAGESENDER \
  NS_IMETHOD SendAsyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMESSAGESENDER(_to) \
  NS_IMETHOD SendAsyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc) { return _to SendAsyncMessage(messageName, obj, objects, cx, _argc); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMESSAGESENDER(_to) \
  NS_IMETHOD SendAsyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc) { return !_to ? NS_ERROR_NULL_POINTER : _to->SendAsyncMessage(messageName, obj, objects, cx, _argc); } 
...
/* [implicit_jscontext,optional_argc] void sendAsyncMessage ([optional] in AString messageName, [optional] in jsval obj, [optional] in jsval objects); */
NS_IMETHODIMP nsMessageSender::SendAsyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsIMessageBroadcaster : public nsIMessageListenerManager {
 public: 
  ...
  NS_IMETHOD BroadcastAsyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc) = 0;
...
#define NS_DECL_NSIMESSAGEBROADCASTER \
  NS_IMETHOD BroadcastAsyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc); \
...
#define NS_FORWARD_NSIMESSAGEBROADCASTER(_to) \
  NS_IMETHOD BroadcastAsyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc) { return _to BroadcastAsyncMessage(messageName, obj, objects, cx, _argc); } \
...
#define NS_FORWARD_SAFE_NSIMESSAGEBROADCASTER(_to) \
  NS_IMETHOD BroadcastAsyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc) { return !_to ? NS_ERROR_NULL_POINTER : _to->BroadcastAsyncMessage(messageName, obj, objects, cx, _argc); } \
...
/* [implicit_jscontext,optional_argc] void broadcastAsyncMessage ([optional] in AString messageName, [optional] in jsval obj, [optional] in jsval objects); */
NS_IMETHODIMP nsMessageBroadcaster::BroadcastAsyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsISyncMessageSender : public nsIMessageSender {
 public: 
  ...
  /* [implicit_jscontext,optional_argc] jsval sendSyncMessage ([optional] in AString messageName, [optional] in jsval obj, [optional] in jsval objects); */
  NS_IMETHOD SendSyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc, JS::Value *_retval) = 0;
...
#define NS_DECL_NSISYNCMESSAGESENDER \
  NS_IMETHOD SendSyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc, JS::Value *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISYNCMESSAGESENDER(_to) \
  NS_IMETHOD SendSyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc, JS::Value *_retval) { return _to SendSyncMessage(messageName, obj, objects, cx, _argc, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISYNCMESSAGESENDER(_to) \
  NS_IMETHOD SendSyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc, JS::Value *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SendSyncMessage(messageName, obj, objects, cx, _argc, _retval); } 
...
/* [implicit_jscontext,optional_argc] jsval sendSyncMessage ([optional] in AString messageName, [optional] in jsval obj, [optional] in jsval objects); */
NS_IMETHODIMP nsSyncMessageSender::SendSyncMessage(const nsAString & messageName, const JS::Value & obj, const JS::Value & objects, JSContext* cx, uint8_t _argc, JS::Value *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_IPROCESSCHECKER_IID_STR "b37821ff-df79-44d4-821c-6d6ec4dfe1e9"

#define NS_IPROCESSCHECKER_IID \
  {0xb37821ff, 0xdf79, 0x44d4, \
    { 0x82, 0x1c, 0x6d, 0x6e, 0xc4, 0xdf, 0xe1, 0xe9 }}
...
class NS_NO_VTABLE nsIProcessChecker : public nsISupports {
 public: 
  ...
  NS_IMETHOD CheckAppHasStatus(uint16_t aStatus, bool *_retval) = 0;
...
#define NS_DECL_NSIPROCESSCHECKER \
  ...
  NS_IMETHOD CheckAppHasStatus(uint16_t aStatus, bool *_retval); 
...
#define NS_FORWARD_NSIPROCESSCHECKER(_to) \
  ...
  NS_IMETHOD CheckAppHasStatus(uint16_t aStatus, bool *_retval) { return _to CheckAppHasStatus(aStatus, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPROCESSCHECKER(_to) \
  ...
  NS_IMETHOD CheckAppHasStatus(uint16_t aStatus, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckAppHasStatus(aStatus, _retval); } 
...
/* boolean checkAppHasStatus (in unsigned short aStatus); */
NS_IMETHODIMP nsProcessChecker::CheckAppHasStatus(uint16_t aStatus, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
