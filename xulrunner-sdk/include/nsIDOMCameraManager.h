/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/dom/camera/nsIDOMCameraManager.idl
 */
...
/* starting interface:    nsICameraPreviewStateChange */
#define NS_ICAMERAPREVIEWSTATECHANGE_IID_STR "d1634592-43fd-4117-a2b2-419aec841cc4"

#define NS_ICAMERAPREVIEWSTATECHANGE_IID \
  {0xd1634592, 0x43fd, 0x4117, \
    { 0xa2, 0xb2, 0x41, 0x9a, 0xec, 0x84, 0x1c, 0xc4 }}

class NS_NO_VTABLE nsICameraPreviewStateChange : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ICAMERAPREVIEWSTATECHANGE_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsICameraPreviewStateChange, NS_ICAMERAPREVIEWSTATECHANGE_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSICAMERAPREVIEWSTATECHANGE \
  NS_IMETHOD HandleStateChange(const nsAString & newState); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICAMERAPREVIEWSTATECHANGE(_to) \
  NS_IMETHOD HandleStateChange(const nsAString & newState) { return _to HandleStateChange(newState); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICAMERAPREVIEWSTATECHANGE(_to) \
  NS_IMETHOD HandleStateChange(const nsAString & newState) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleStateChange(newState); } 
...
/* Header file */
class nsCameraPreviewStateChange : public nsICameraPreviewStateChange
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSICAMERAPREVIEWSTATECHANGE

  nsCameraPreviewStateChange();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsCameraPreviewStateChange, nsICameraPreviewStateChange)

nsCameraPreviewStateChange::nsCameraPreviewStateChange()
{
  /* member initializers and constructor code */
}
...
/* void handleStateChange (in DOMString newState); */
NS_IMETHODIMP nsCameraPreviewStateChange::HandleStateChange(const nsAString & newState)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_ICAMERACONTROL_IID_STR "74dc7f1f-c88f-4774-860b-44aef9de5dc8"

#define NS_ICAMERACONTROL_IID \
  {0x74dc7f1f, 0xc88f, 0x4774, \
    { 0x86, 0x0b, 0x44, 0xae, 0xf9, 0xde, 0x5d, 0xc8 }}
...
class NS_NO_VTABLE nsICameraControl : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetOnPreviewStateChange(nsICameraPreviewStateChange * *aOnPreviewStateChange) = 0;
  NS_IMETHOD SetOnPreviewStateChange(nsICameraPreviewStateChange *aOnPreviewStateChange) = 0;
...
#define NS_DECL_NSICAMERACONTROL \
  ...
  NS_IMETHOD GetOnPreviewStateChange(nsICameraPreviewStateChange * *aOnPreviewStateChange); \
  NS_IMETHOD SetOnPreviewStateChange(nsICameraPreviewStateChange *aOnPreviewStateChange); \
...
#define NS_FORWARD_NSICAMERACONTROL(_to) \
  ...
  NS_IMETHOD GetOnPreviewStateChange(nsICameraPreviewStateChange * *aOnPreviewStateChange) { return _to GetOnPreviewStateChange(aOnPreviewStateChange); } \
  NS_IMETHOD SetOnPreviewStateChange(nsICameraPreviewStateChange *aOnPreviewStateChange) { return _to SetOnPreviewStateChange(aOnPreviewStateChange); } \
...
#define NS_FORWARD_SAFE_NSICAMERACONTROL(_to) \
  ...
  NS_IMETHOD GetOnPreviewStateChange(nsICameraPreviewStateChange * *aOnPreviewStateChange) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOnPreviewStateChange(aOnPreviewStateChange); } \
  NS_IMETHOD SetOnPreviewStateChange(nsICameraPreviewStateChange *aOnPreviewStateChange) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOnPreviewStateChange(aOnPreviewStateChange); } \
...
/* attribute nsICameraPreviewStateChange onPreviewStateChange; */
NS_IMETHODIMP nsCameraControl::GetOnPreviewStateChange(nsICameraPreviewStateChange * *aOnPreviewStateChange)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsCameraControl::SetOnPreviewStateChange(nsICameraPreviewStateChange *aOnPreviewStateChange)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
