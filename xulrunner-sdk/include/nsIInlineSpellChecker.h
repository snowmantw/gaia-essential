/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/editor/txtsvc/public/nsIInlineSpellChecker.idl
 */
...
#define NS_DECL_NSIINLINESPELLCHECKER \
  ...
  NS_IMETHOD GetSpellCheckPending(bool *aSpellCheckPending); 
...
#define NS_FORWARD_NSIINLINESPELLCHECKER(_to) \
  ...
  NS_IMETHOD GetSpellCheckPending(bool *aSpellCheckPending) { return _to GetSpellCheckPending(aSpellCheckPending); } 
...
#define NS_FORWARD_SAFE_NSIINLINESPELLCHECKER(_to) \
  ...
  NS_IMETHOD GetSpellCheckPending(bool *aSpellCheckPending) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSpellCheckPending(aSpellCheckPending); } 
