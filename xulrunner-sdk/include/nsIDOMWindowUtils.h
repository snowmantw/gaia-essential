/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/dom/interfaces/base/nsIDOMWindowUtils.idl
 */
...
#define NS_IDOMWINDOWUTILS_IID_STR "cbe333d7-5b2c-4a9b-b99b-e6e388afa62b"

#define NS_IDOMWINDOWUTILS_IID \
  {0xcbe333d7, 0x5b2c, 0x4a9b, \
    { 0xb9, 0x9b, 0xe6, 0xe3, 0x88, 0xaf, 0xa6, 0x2b }}
...
class NS_NO_VTABLE nsIDOMWindowUtils : public nsISupports {
 public: 
  ...
  /* AString getOMTAOrComputedStyle (in nsIDOMNode aNode, in AString aProperty); */
  NS_IMETHOD GetOMTAOrComputedStyle(nsIDOMNode *aNode, const nsAString & aProperty, nsAString & _retval) = 0;
...
#define NS_DECL_NSIDOMWINDOWUTILS \
  ...
  NS_IMETHOD GetOMTAOrComputedStyle(nsIDOMNode *aNode, const nsAString & aProperty, nsAString & _retval); 
...
#define NS_FORWARD_NSIDOMWINDOWUTILS(_to) \
  ...
  NS_IMETHOD GetOMTAOrComputedStyle(nsIDOMNode *aNode, const nsAString & aProperty, nsAString & _retval) { return _to GetOMTAOrComputedStyle(aNode, aProperty, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMWINDOWUTILS(_to) \
  ...
  NS_IMETHOD GetOMTAOrComputedStyle(nsIDOMNode *aNode, const nsAString & aProperty, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOMTAOrComputedStyle(aNode, aProperty, _retval); } 
...
/* AString getOMTAOrComputedStyle (in nsIDOMNode aNode, in AString aProperty); */
NS_IMETHODIMP nsDOMWindowUtils::GetOMTAOrComputedStyle(nsIDOMNode *aNode, const nsAString & aProperty, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
