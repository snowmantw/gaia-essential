/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/netwerk/socket/nsISSLSocketControl.idl
 */
...
#define NS_ISSLSOCKETCONTROL_IID_STR "c5eb9af4-238c-4fc6-bdec-d5ab5e7dce68"

#define NS_ISSLSOCKETCONTROL_IID \
  {0xc5eb9af4, 0x238c, 0x4fc6, \
    { 0xbd, 0xec, 0xd5, 0xab, 0x5e, 0x7d, 0xce, 0x68 }}
...
class NS_NO_VTABLE nsISSLSocketControl : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetSymmetricCipherUsed(int16_t *aSymmetricCipherUsed) = 0;
  inline int16_t GetSymmetricCipherUsed()
  {
    int16_t result;
    mozilla::DebugOnly<nsresult> rv = GetSymmetricCipherUsed(&result);
    MOZ_ASSERT(NS_SUCCEEDED(rv));
    return result;
  }

  /* [infallible] attribute short SymmetricCipherExpected; */
  NS_IMETHOD GetSymmetricCipherExpected(int16_t *aSymmetricCipherExpected) = 0;
  ...
  NS_IMETHOD SetSymmetricCipherExpected(int16_t aSymmetricCipherExpected) = 0;

  enum {
    KEY_EXCHANGE_UNKNOWN = -1,
    SYMMETRIC_CIPHER_UNKNOWN = -1
  };
...
#define NS_DECL_NSISSLSOCKETCONTROL \
  ...
  NS_IMETHOD GetSymmetricCipherUsed(int16_t *aSymmetricCipherUsed); \
  NS_IMETHOD GetSymmetricCipherExpected(int16_t *aSymmetricCipherExpected); \
  NS_IMETHOD SetSymmetricCipherExpected(int16_t aSymmetricCipherExpected); \
...
#define NS_FORWARD_NSISSLSOCKETCONTROL(_to) \
  ...
  NS_IMETHOD GetSymmetricCipherUsed(int16_t *aSymmetricCipherUsed) { return _to GetSymmetricCipherUsed(aSymmetricCipherUsed); } \
  NS_IMETHOD GetSymmetricCipherExpected(int16_t *aSymmetricCipherExpected) { return _to GetSymmetricCipherExpected(aSymmetricCipherExpected); } \
  NS_IMETHOD SetSymmetricCipherExpected(int16_t aSymmetricCipherExpected) { return _to SetSymmetricCipherExpected(aSymmetricCipherExpected); } \
...
#define NS_FORWARD_SAFE_NSISSLSOCKETCONTROL(_to) \
  ...
  NS_IMETHOD GetSymmetricCipherUsed(int16_t *aSymmetricCipherUsed) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSymmetricCipherUsed(aSymmetricCipherUsed); } \
  NS_IMETHOD GetSymmetricCipherExpected(int16_t *aSymmetricCipherExpected) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSymmetricCipherExpected(aSymmetricCipherExpected); } \
  NS_IMETHOD SetSymmetricCipherExpected(int16_t aSymmetricCipherExpected) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSymmetricCipherExpected(aSymmetricCipherExpected); } \
...
/* [infallible] readonly attribute short SymmetricCipherUsed; */
NS_IMETHODIMP nsSSLSocketControl::GetSymmetricCipherUsed(int16_t *aSymmetricCipherUsed)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [infallible] attribute short SymmetricCipherExpected; */
NS_IMETHODIMP nsSSLSocketControl::GetSymmetricCipherExpected(int16_t *aSymmetricCipherExpected)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsSSLSocketControl::SetSymmetricCipherExpected(int16_t aSymmetricCipherExpected)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
