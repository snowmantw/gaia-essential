/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/toolkit/components/places/mozIAsyncHistory.idl
 */
...
class NS_NO_VTABLE mozIAsyncHistory : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetPlacesInfo(const JS::Value & aPlaceIdentifiers, mozIVisitInfoCallback *aCallback, JSContext* cx) = 0;
...
#define NS_DECL_MOZIASYNCHISTORY \
  NS_IMETHOD GetPlacesInfo(const JS::Value & aPlaceIdentifiers, mozIVisitInfoCallback *aCallback, JSContext* cx); \
...
#define NS_FORWARD_MOZIASYNCHISTORY(_to) \
  NS_IMETHOD GetPlacesInfo(const JS::Value & aPlaceIdentifiers, mozIVisitInfoCallback *aCallback, JSContext* cx) { return _to GetPlacesInfo(aPlaceIdentifiers, aCallback, cx); } \
...
#define NS_FORWARD_SAFE_MOZIASYNCHISTORY(_to) \
  NS_IMETHOD GetPlacesInfo(const JS::Value & aPlaceIdentifiers, mozIVisitInfoCallback *aCallback, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPlacesInfo(aPlaceIdentifiers, aCallback, cx); } \
...
/* [implicit_jscontext] void getPlacesInfo (in jsval aPlaceIdentifiers, in mozIVisitInfoCallback aCallback); */
NS_IMETHODIMP _MYCLASS_::GetPlacesInfo(const JS::Value & aPlaceIdentifiers, mozIVisitInfoCallback *aCallback, JSContext* cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
