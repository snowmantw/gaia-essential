/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/dom/interfaces/apps/nsIDOMApplicationRegistry.idl
 */
...
#define MOZIDOMAPPLICATION_IID_STR "8bdeef38-e9cd-46f8-b8de-ed9e6b4d01ea"

#define MOZIDOMAPPLICATION_IID \
  {0x8bdeef38, 0xe9cd, 0x46f8, \
    { 0xb8, 0xde, 0xed, 0x9e, 0x6b, 0x4d, 0x01, 0xea }}
...
class NS_NO_VTABLE mozIDOMApplication : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetDownloadError(nsISupports * *aDownloadError) = 0;
  ...
  NS_IMETHOD ClearBrowserData(nsIDOMDOMRequest * *_retval) = 0;
...
#define NS_DECL_MOZIDOMAPPLICATION \
  ...
  NS_IMETHOD GetDownloadError(nsISupports * *aDownloadError); \
  ...
  NS_IMETHOD ClearBrowserData(nsIDOMDOMRequest * *_retval); 
...
#define NS_FORWARD_MOZIDOMAPPLICATION(_to) \
  ...
  NS_IMETHOD GetDownloadError(nsISupports * *aDownloadError) { return _to GetDownloadError(aDownloadError); } \
  ...
  NS_IMETHOD ClearBrowserData(nsIDOMDOMRequest * *_retval) { return _to ClearBrowserData(_retval); } 
...
#define NS_FORWARD_SAFE_MOZIDOMAPPLICATION(_to) \
  ...
  NS_IMETHOD GetDownloadError(nsISupports * *aDownloadError) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDownloadError(aDownloadError); } \
  ...
  NS_IMETHOD ClearBrowserData(nsIDOMDOMRequest * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ClearBrowserData(_retval); } 
...
/* readonly attribute nsISupports downloadError; */
NS_IMETHODIMP _MYCLASS_::GetDownloadError(nsISupports * *aDownloadError)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIDOMDOMRequest clearBrowserData (); */
NS_IMETHODIMP _MYCLASS_::ClearBrowserData(nsIDOMDOMRequest * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define MOZIDOMAPPLICATIONREGISTRY_IID_STR "52710c5f-b2a2-4b27-b5b9-f679a1bcc79b"

#define MOZIDOMAPPLICATIONREGISTRY_IID \
  {0x52710c5f, 0xb2a2, 0x4b27, \
    { 0xb5, 0xb9, 0xf6, 0x79, 0xa1, 0xbc, 0xc7, 0x9b }}
