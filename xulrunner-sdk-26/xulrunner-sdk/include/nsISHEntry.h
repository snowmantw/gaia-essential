/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/docshell/shistory/public/nsISHEntry.idl
 */
...
#define NS_ISHENTRY_IID_STR "162ea0eb-e577-4b9a-af9d-a94e8350b029"

#define NS_ISHENTRY_IID \
  {0x162ea0eb, 0xe577, 0x4b9a, \
    { 0xaf, 0x9d, 0xa9, 0x4e, 0x83, 0x50, 0xb0, 0x29 }}
...
#define NS_DECL_NSISHENTRY \
  ...
  NS_IMETHOD GetIsSrcdocEntry(bool *aIsSrcdocEntry); \
...
#define NS_FORWARD_NSISHENTRY(_to) \
  ...
  NS_IMETHOD GetIsSrcdocEntry(bool *aIsSrcdocEntry) { return _to GetIsSrcdocEntry(aIsSrcdocEntry); } \
...
#define NS_FORWARD_SAFE_NSISHENTRY(_to) \
  ...
  NS_IMETHOD GetIsSrcdocEntry(bool *aIsSrcdocEntry) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsSrcdocEntry(aIsSrcdocEntry); } \
