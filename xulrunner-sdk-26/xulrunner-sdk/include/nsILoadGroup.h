/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/netwerk/base/public/nsILoadGroup.idl
 */
...
#define NS_ILOADGROUPCONNECTIONINFO_IID_STR "5361f30e-f968-437c-8f41-69d2756a6022"

#define NS_ILOADGROUPCONNECTIONINFO_IID \
  {0x5361f30e, 0xf968, 0x437c, \
    { 0x8f, 0x41, 0x69, 0xd2, 0x75, 0x6a, 0x60, 0x22 }}
...
class NS_NO_VTABLE nsILoadGroupConnectionInfo : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetSpdyPushCache3(mozilla::net::SpdyPushCache3 **aSpdyPushCache3) = 0;
  NS_IMETHOD SetSpdyPushCache3(mozilla::net::SpdyPushCache3 *aSpdyPushCache3) = 0;
...
#define NS_DECL_NSILOADGROUPCONNECTIONINFO \
  ...
  NS_IMETHOD GetSpdyPushCache3(mozilla::net::SpdyPushCache3 **aSpdyPushCache3); \
  NS_IMETHOD SetSpdyPushCache3(mozilla::net::SpdyPushCache3 *aSpdyPushCache3); 
...
#define NS_FORWARD_NSILOADGROUPCONNECTIONINFO(_to) \
  ...
  NS_IMETHOD GetSpdyPushCache3(mozilla::net::SpdyPushCache3 **aSpdyPushCache3) { return _to GetSpdyPushCache3(aSpdyPushCache3); } \
  NS_IMETHOD SetSpdyPushCache3(mozilla::net::SpdyPushCache3 *aSpdyPushCache3) { return _to SetSpdyPushCache3(aSpdyPushCache3); } 
...
#define NS_FORWARD_SAFE_NSILOADGROUPCONNECTIONINFO(_to) \
  ...
  NS_IMETHOD GetSpdyPushCache3(mozilla::net::SpdyPushCache3 **aSpdyPushCache3) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSpdyPushCache3(aSpdyPushCache3); } \
  NS_IMETHOD SetSpdyPushCache3(mozilla::net::SpdyPushCache3 *aSpdyPushCache3) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSpdyPushCache3(aSpdyPushCache3); } 
...
/* [noscript] attribute SpdyPushCache3Ptr spdyPushCache3; */
NS_IMETHODIMP nsLoadGroupConnectionInfo::GetSpdyPushCache3(mozilla::net::SpdyPushCache3 **aSpdyPushCache3)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsLoadGroupConnectionInfo::SetSpdyPushCache3(mozilla::net::SpdyPushCache3 *aSpdyPushCache3)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
