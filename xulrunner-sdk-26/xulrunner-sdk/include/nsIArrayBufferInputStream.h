/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/netwerk/base/public/nsIArrayBufferInputStream.idl
 */
...
class NS_NO_VTABLE nsIArrayBufferInputStream : public nsIInputStream {
 public: 
  ...
  NS_IMETHOD SetData(const JS::Value & buffer, uint32_t byteOffset, uint32_t byteLen, JSContext* cx) = 0;
...
#define NS_DECL_NSIARRAYBUFFERINPUTSTREAM \
  NS_IMETHOD SetData(const JS::Value & buffer, uint32_t byteOffset, uint32_t byteLen, JSContext* cx); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIARRAYBUFFERINPUTSTREAM(_to) \
  NS_IMETHOD SetData(const JS::Value & buffer, uint32_t byteOffset, uint32_t byteLen, JSContext* cx) { return _to SetData(buffer, byteOffset, byteLen, cx); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIARRAYBUFFERINPUTSTREAM(_to) \
  NS_IMETHOD SetData(const JS::Value & buffer, uint32_t byteOffset, uint32_t byteLen, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetData(buffer, byteOffset, byteLen, cx); } 
...
/* [implicit_jscontext] void setData (in jsval buffer, in unsigned long byteOffset, in unsigned long byteLen); */
NS_IMETHODIMP nsArrayBufferInputStream::SetData(const JS::Value & buffer, uint32_t byteOffset, uint32_t byteLen, JSContext* cx)
{
