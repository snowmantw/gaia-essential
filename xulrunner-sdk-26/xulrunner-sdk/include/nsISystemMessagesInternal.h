/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/dom/messages/interfaces/nsISystemMessagesInternal.idl
 */
...
class NS_NO_VTABLE nsISystemMessagesInternal : public nsISupports {
 public: 
  ...
  NS_IMETHOD SendMessage(const nsAString & type, const JS::Value & message, nsIURI *pageURI, nsIURI *manifestURI, const JS::Value & extra) = 0;

  /* void broadcastMessage (in DOMString type, in jsval message, [optional] in jsval extra); */
  NS_IMETHOD BroadcastMessage(const nsAString & type, const JS::Value & message, const JS::Value & extra) = 0;
...
#define NS_DECL_NSISYSTEMMESSAGESINTERNAL \
  NS_IMETHOD SendMessage(const nsAString & type, const JS::Value & message, nsIURI *pageURI, nsIURI *manifestURI, const JS::Value & extra); \
  NS_IMETHOD BroadcastMessage(const nsAString & type, const JS::Value & message, const JS::Value & extra); \
...
#define NS_FORWARD_NSISYSTEMMESSAGESINTERNAL(_to) \
  NS_IMETHOD SendMessage(const nsAString & type, const JS::Value & message, nsIURI *pageURI, nsIURI *manifestURI, const JS::Value & extra) { return _to SendMessage(type, message, pageURI, manifestURI, extra); } \
  NS_IMETHOD BroadcastMessage(const nsAString & type, const JS::Value & message, const JS::Value & extra) { return _to BroadcastMessage(type, message, extra); } \
...
#define NS_FORWARD_SAFE_NSISYSTEMMESSAGESINTERNAL(_to) \
  NS_IMETHOD SendMessage(const nsAString & type, const JS::Value & message, nsIURI *pageURI, nsIURI *manifestURI, const JS::Value & extra) { return !_to ? NS_ERROR_NULL_POINTER : _to->SendMessage(type, message, pageURI, manifestURI, extra); } \
  NS_IMETHOD BroadcastMessage(const nsAString & type, const JS::Value & message, const JS::Value & extra) { return !_to ? NS_ERROR_NULL_POINTER : _to->BroadcastMessage(type, message, extra); } \
...
/* void sendMessage (in DOMString type, in jsval message, in nsIURI pageURI, in nsIURI manifestURI, [optional] in jsval extra); */
NS_IMETHODIMP nsSystemMessagesInternal::SendMessage(const nsAString & type, const JS::Value & message, nsIURI *pageURI, nsIURI *manifestURI, const JS::Value & extra)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void broadcastMessage (in DOMString type, in jsval message, [optional] in jsval extra); */
NS_IMETHODIMP nsSystemMessagesInternal::BroadcastMessage(const nsAString & type, const JS::Value & message, const JS::Value & extra)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
