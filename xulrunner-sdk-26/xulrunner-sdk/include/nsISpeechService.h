/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/content/media/webspeech/synth/nsISpeechService.idl
 */
...
#define NS_ISPEECHTASK_IID_STR "3a60c397-7a04-4cf7-99ea-7432e7a0a1c1"

#define NS_ISPEECHTASK_IID \
  {0x3a60c397, 0x7a04, 0x4cf7, \
    { 0x99, 0xea, 0x74, 0x32, 0xe7, 0xa0, 0xa1, 0xc1 }}
...
class NS_NO_VTABLE nsISpeechTask : public nsISupports {
 public: 
  ...
  NS_IMETHOD SendAudio(const JS::Value & aData, const JS::Value & aLandmarks, JSContext* cx) = 0;
...
#define NS_DECL_NSISPEECHTASK \
  ...
  NS_IMETHOD SendAudio(const JS::Value & aData, const JS::Value & aLandmarks, JSContext* cx); \
...
#define NS_FORWARD_NSISPEECHTASK(_to) \
  ...
  NS_IMETHOD SendAudio(const JS::Value & aData, const JS::Value & aLandmarks, JSContext* cx) { return _to SendAudio(aData, aLandmarks, cx); } \
...
#define NS_FORWARD_SAFE_NSISPEECHTASK(_to) \
  ...
  NS_IMETHOD SendAudio(const JS::Value & aData, const JS::Value & aLandmarks, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->SendAudio(aData, aLandmarks, cx); } \
...
/* [implicit_jscontext] void sendAudio (in jsval aData, in jsval aLandmarks); */
NS_IMETHODIMP nsSpeechTask::SendAudio(const JS::Value & aData, const JS::Value & aLandmarks, JSContext* cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
