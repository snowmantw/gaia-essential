/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/docshell/base/nsIDocShellTreeOwner.idl
 */
...
class NS_NO_VTABLE nsIDocShellTreeOwner : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetContentWindow(JSContext* cx, JS::Value *aContentWindow) = 0;
...
#define NS_DECL_NSIDOCSHELLTREEOWNER \
  ...
  NS_IMETHOD GetContentWindow(JSContext* cx, JS::Value *aContentWindow); \
...
#define NS_FORWARD_NSIDOCSHELLTREEOWNER(_to) \
  ...
  NS_IMETHOD GetContentWindow(JSContext* cx, JS::Value *aContentWindow) { return _to GetContentWindow(cx, aContentWindow); } \
...
#define NS_FORWARD_SAFE_NSIDOCSHELLTREEOWNER(_to) \
  ...
  NS_IMETHOD GetContentWindow(JSContext* cx, JS::Value *aContentWindow) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetContentWindow(cx, aContentWindow); } \
...
/* [implicit_jscontext] readonly attribute jsval contentWindow; */
NS_IMETHODIMP nsDocShellTreeOwner::GetContentWindow(JSContext* cx, JS::Value *aContentWindow)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
