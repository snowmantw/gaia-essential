/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/dom/interfaces/html/nsIDOMHTMLIFrameElement.idl
 */
...
#define NS_IDOMHTMLIFRAMEELEMENT_IID_STR "60d9bcf1-3b0c-4704-ae8c-5b6ac0180b2e"

#define NS_IDOMHTMLIFRAMEELEMENT_IID \
  {0x60d9bcf1, 0x3b0c, 0x4704, \
    { 0xae, 0x8c, 0x5b, 0x6a, 0xc0, 0x18, 0x0b, 0x2e }}
...
#define NS_DECL_NSIDOMHTMLIFRAMEELEMENT \
  ...
  NS_IMETHOD GetSrcdoc(nsAString & aSrcdoc); \
  NS_IMETHOD SetSrcdoc(const nsAString & aSrcdoc); \
...
#define NS_FORWARD_NSIDOMHTMLIFRAMEELEMENT(_to) \
  ...
  NS_IMETHOD GetSrcdoc(nsAString & aSrcdoc) { return _to GetSrcdoc(aSrcdoc); } \
  NS_IMETHOD SetSrcdoc(const nsAString & aSrcdoc) { return _to SetSrcdoc(aSrcdoc); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLIFRAMEELEMENT(_to) \
  ...
  NS_IMETHOD GetSrcdoc(nsAString & aSrcdoc) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSrcdoc(aSrcdoc); } \
  NS_IMETHOD SetSrcdoc(const nsAString & aSrcdoc) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSrcdoc(aSrcdoc); } \
