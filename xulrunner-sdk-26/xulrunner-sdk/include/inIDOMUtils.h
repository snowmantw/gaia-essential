/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/m-cen-osx64-xr-ntly-0000000000/build/layout/inspector/public/inIDOMUtils.idl
 */
...
#define INIDOMUTILS_IID_STR "ceae6c68-f5d4-4597-a3d9-ca5646c25f1a"

#define INIDOMUTILS_IID \
  {0xceae6c68, 0xf5d4, 0x4597, \
    { 0xa3, 0xd9, 0xca, 0x56, 0x46, 0xc2, 0x5f, 0x1a }}
...
class NS_NO_VTABLE inIDOMUtils : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetCSSValuesForProperty(const nsAString & aProperty, uint32_t *aLength, PRUnichar * **aValues) = 0;
...
#define NS_DECL_INIDOMUTILS \
  NS_IMETHOD GetAllStyleSheets(nsIDOMDocument *aDoc, uint32_t *aLength, nsISupports * **aSheets); \
  ...
  NS_IMETHOD GetCSSValuesForProperty(const nsAString & aProperty, uint32_t *aLength, PRUnichar * **aValues); \
...
#define NS_FORWARD_INIDOMUTILS(_to) \
  NS_IMETHOD GetAllStyleSheets(nsIDOMDocument *aDoc, uint32_t *aLength, nsISupports * **aSheets) { return _to GetAllStyleSheets(aDoc, aLength, aSheets); } \
  ...
  NS_IMETHOD GetCSSValuesForProperty(const nsAString & aProperty, uint32_t *aLength, PRUnichar * **aValues) { return _to GetCSSValuesForProperty(aProperty, aLength, aValues); } \
...
#define NS_FORWARD_SAFE_INIDOMUTILS(_to) \
  NS_IMETHOD GetAllStyleSheets(nsIDOMDocument *aDoc, uint32_t *aLength, nsISupports * **aSheets) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAllStyleSheets(aDoc, aLength, aSheets); } \
  ...
  NS_IMETHOD GetCSSValuesForProperty(const nsAString & aProperty, uint32_t *aLength, PRUnichar * **aValues) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCSSValuesForProperty(aProperty, aLength, aValues); } \
...
/* void getCSSValuesForProperty (in AString aProperty, [optional] out unsigned long aLength, [array, size_is (aLength), retval] out wstring aValues); */
NS_IMETHODIMP inDOMUtils::GetCSSValuesForProperty(const nsAString & aProperty, uint32_t *aLength, PRUnichar * **aValues)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
